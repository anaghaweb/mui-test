...
const EcoboNavbarVariant = React.forwardRef(function EcoboNavbarVariant(inProps, ref) {
...
EcoboNavbarVariant.propTypes = {
    variant: PropTypes.oneOf(['ecobo','base']),
};

function EcoboNavbar({variant}) {
       return (
        <EcoboNavbarVariant variant="ecobo" />  
    );
}
